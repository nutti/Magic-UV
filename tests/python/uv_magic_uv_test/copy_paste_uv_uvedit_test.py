...
class TestCopyPasteUVUVEdit(common.TestBase):
    ...
    idname = [
        ...
        ('OPERATOR', 'uv.muv_copy_paste_uv_uvedit_operator_copy_uv'),
        ('OPERATOR', 'uv.muv_copy_paste_uv_uvedit_operator_paste_uv'),
    ]
    ...
    def test_copy_uv_ok(self):
        ...
        result = bpy.ops.uv.muv_copy_paste_uv_uvedit_operator_copy_uv()
    ...
    def test_paste_uv_ok(self):
        ...
        bpy.ops.mesh.uv_texture_add()
        bpy.ops.mesh.select_all(action='SELECT')
        result = bpy.ops.uv.muv_copy_paste_uv_uvedit_operator_paste_uv()
        self.assertSetEqual(result, {'FINISHED'})