...
class TestTextureLock(common.TestBase):
    ...
    idname = [
        # Texture Lock
        ('OPERATOR', 'uv.muv_texture_lock_operator_lock'),
        ('OPERATOR', 'uv.muv_texture_lock_operator_unlock'),
    ]
    ...
    def test_lock_ng_no_uv(self):
        ...
        result = bpy.ops.uv.muv_texture_lock_operator_lock()
    ...
    def test_unlock_ng_no_uv(self):
        ...
        bpy.ops.mesh.select_all(action='SELECT')
        result = bpy.ops.uv.muv_texture_lock_operator_unlock()
        self.assertSetEqual(result, {'CANCELLED'})
...
class TestTextureLockIntr(common.TestBase):
    ...
    idname = [
        # Texture Lock
        ('OPERATOR', 'uv.muv_texture_lock_operator_intr'),
    ]
